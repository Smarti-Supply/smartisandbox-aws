...
def create_timeline_events(
    ...
    Returns:
        Lista de eventos ordenados por data, cada um com 'date' e 'description'
    """
    events = []
...
def generate_pdf(
    ...
    if events:
        ...
        table_data = [[Paragraph('<b>Data</b>', normal_style), Paragraph('<b>Descrição</b>', normal_style)]]
        ...
        table_data = [
            [Paragraph('<b>Data</b>', normal_style), Paragraph('<b>Descrição</b>', normal_style)],
            [Paragraph('-', normal_style), Paragraph('Nenhum evento registrado', normal_style)]
        ]
